        ...
        <main class="content clearfix">
            ...
            <div class="home-menu">
                <ul class="menu menu-main">
                    <li><a href="#"><span class="stay">Stay</span></a></li>
                    <li><a href="#"><span class="play">Play</span></a></li>
                    <li><a href="#"><span class="dine">Dine</span></a></li>
                    <li><a href="#"><span class="shop">Shop</span></a></li>
                    <li><a href="#"><span class="events">Events</span></a></li>
